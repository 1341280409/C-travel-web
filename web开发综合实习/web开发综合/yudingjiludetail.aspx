                      ...
                      <tr>
                        ...
                        <td height="233" valign="top" bgcolor="#F6F9F2">
                          ...
                          <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse" class="newsline"> 
								<tr>
								 <td width='11%'>酒店名称：</td><td width='39%'><%=njiudianmingcheng%></td>			<td width='11%'>所在城市：</td><td width='39%'><%=nsuozaichengshi%></td></tr><tr>			<td width='11%'>房号：</td><td width='39%'><%=nfanghao%></td>			<td width='11%'>房间类型：</td><td width='39%'><%=nfangjianleixing%></td></tr><tr>			<td width='11%'>价格：</td><td width='39%'><%=njiage%></td>			<td width='11%'>预订人：</td><td width='39%'><%=nyudingren%></td></tr><tr>			<td width='11%'>联系方式：</td><td width='39%'><%=nlianxifangshi%></td>			<td width='11%'>预订日期：</td><td width='39%'><%=nyudingriqi%></td></tr><tr>			<td width='11%'>预订天数：</td><td width='39%'><%=nyudingtianshu%></td>			<td width='11%'>金额：</td><td width='39%'><%=njine%></td>			</tr><tr><td colspan=4 align=center><input type=button name=Submit5 value=返回 style='border:solid 1px #000000; color:#666666' onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" style='border:solid 1px #000000; color:#666666' /></td></tr>
