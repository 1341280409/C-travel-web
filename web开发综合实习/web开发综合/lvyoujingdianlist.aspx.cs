...
public partial class lvyoujingdianlist : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
			...
			//addlixandxongxlz
            string sql;
            sql = "select * from lvyoujingdian order by id desc";
            getdata(sql);
        }
    }
    ...
    {
        Response.Redirect("lvyoujingdianlisttp.aspx");
    }
