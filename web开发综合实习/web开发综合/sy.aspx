...
<body>
  ...
  <tr>
    <td><div style='float:left'> <img height="14" src="skin/images/frame/book1.gif" width="20" />&nbsp;欢迎使用 旅游网站 </div>
  ...
  <tr bgcolor="#FFFFFF">
    <td height="30" colspan="2" align="center" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          ...
          <td width="85%" valign="bottom" align=left><p>作者：小组全部成员</p>
          <p>指导老师：刘颖</p>
          <p>所在学院：山东石油化工学院基础科学学院</p></td>
        </tr>
      </table></td>
  </tr>
</table>
...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><a href="https://www.sdipct.edu.cn/" target="_blank"><u>http://www.xxxxx.cn</u></a></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="25%" height="32">联系邮箱：</td>
    <td width="75%"><a href="https://www.sdipct.edu.cn/" target="_blank"><u>xxxxx@163.com</u></a></td>
  </tr>
</table>
</div>
    </form>
