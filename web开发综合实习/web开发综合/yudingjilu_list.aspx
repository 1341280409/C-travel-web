<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yudingjilu_list.aspx.cs" Inherits="yudingjilu_list" %>
...
<body>
    ...
    <div>
        <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
            <tbody>
                <tr class="tr2">
                    <td bgcolor="#f1f8f5" style="padding-left: 5px; height: 25px">所有预订记录列表</td>
                </tr>
                <tr class="tr1">
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField='jiudianmingcheng' HeaderText='酒店名称'></asp:BoundColumn>                                <asp:BoundColumn DataField='suozaichengshi' HeaderText='所在城市'></asp:BoundColumn>                                <asp:BoundColumn DataField='fanghao' HeaderText='房号'></asp:BoundColumn>                                <asp:BoundColumn DataField='fangjianleixing' HeaderText='房间类型'></asp:BoundColumn>                                <asp:BoundColumn DataField='jiage' HeaderText='价格'></asp:BoundColumn>                                <asp:BoundColumn DataField='yudingren' HeaderText='预订人'></asp:BoundColumn>                                <asp:BoundColumn DataField='lianxifangshi' HeaderText='联系方式'></asp:BoundColumn>                                <asp:TemplateColumn HeaderText="预订日期"><ItemTemplate><%# riqigeshi(DataBinder.Eval(Container.DataItem, "yudingriqi"))%></ItemTemplate><HeaderStyle Width="100px" /></asp:TemplateColumn>                                <asp:BoundColumn DataField='yudingtianshu' HeaderText='预订天数'></asp:BoundColumn>                                <asp:BoundColumn DataField='jine' HeaderText='金额'></asp:BoundColumn>                                
                                <asp:TemplateColumn HeaderText="是否审核"><ItemTemplate><a href='sh.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>&yuan=<%#DataBinder.Eval(Container.DataItem, "issh")%>&tablename=yudingjilu' onclick="return confirm('确定要审核？')"><%#DataBinder.Eval(Container.DataItem, "issh") %></a></ItemTemplate><HeaderStyle Width="80px" /></asp:TemplateColumn>
                                ...
                                <asp:TemplateColumn HeaderText="删除">
                                	<ItemTemplate>
                                    	<a href='delid.aspx?delid=<%#DataBinder.Eval(Container.DataItem, "id") %>&tablename=yudingjilu&npage=yudingjilu_list.aspx' onclick="return confirm('确定要删除？')">删除</a>
                               		</ItemTemplate>
								<HeaderStyle Width="50px" />
					
                                </asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="详细"><ItemTemplate><a href='yudingjiludetail.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>' target='_blank'>详细</a></ItemTemplate><HeaderStyle Width="50px" /></asp:TemplateColumn>
                            </Columns>
