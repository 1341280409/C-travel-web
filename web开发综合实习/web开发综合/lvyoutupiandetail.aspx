<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lvyoutupiandetail.aspx.cs" Inherits="lvyoutupiandetail" %>
                      ...
                      <tr>
                        ...
                        <td height="233" valign="top" bgcolor="#F6F9F2">
                          ...
                          <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse" class="newsline"> 
								<tr>
								 <td width='11%' height=44>旅游景区：</td><td width='39%'><%=nlvyoujingqu%></td><td  rowspan=1 align=center><a href="<%=njingqutupian%>" target=_blank><img src=<%=njingqutupian%> width=228 height=215 border=0></a></td></tr><tr>						<td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" style='border:solid 1px #000000; color:#666666' /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" style='border:solid 1px #000000; color:#666666' /></td></tr>
