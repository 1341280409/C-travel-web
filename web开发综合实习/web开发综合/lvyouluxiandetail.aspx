<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lvyouluxiandetail.aspx.cs" Inherits="lvyouluxiandetail" %>
                      ...
                      <tr>
                        ...
                        <td height="233" valign="top" bgcolor="#F6F9F2">
                          ...
                          <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse" class="newsline"> 
								<tr>
								 <td width='11%'>游览日：</td><td width='39%'><%=nyoulanri%></td>			<td width='11%'>旅游性质：</td><td width='39%'><%=nlvyouxingzhi%></td></tr><tr>			<td width='11%'>交通工具：</td><td width='39%'><%=njiaotonggongju%></td>			<td width='11%'>始发城市：</td><td width='39%'><%=nshifachengshi%></td></tr><tr>			<td width='11%'>始发地址：</td><td width='39%'><%=nshifadizhi%></td>			<td width='11%'>目地城市：</td><td width='39%'><%=nmudichengshi%></td></tr><tr>			<td width='11%'>目地地址：</td><td width='39%'><%=nmudidizhi%></td>			<td width='11%'>景区名称：</td><td width='39%'><%=njingqumingcheng%></td></tr><tr>			<td width='11%'>景区级别：</td><td width='39%'><%=njingqujibie%></td>			<td>&nbsp;</td><td>&nbsp;</td></tr><tr><td colspan=4 align=center><input type=button name=Submit5 value=返回 style='border:solid 1px #000000; color:#666666' onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" style='border:solid 1px #000000; color:#666666' /></td></tr>
