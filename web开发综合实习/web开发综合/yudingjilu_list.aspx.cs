...
public partial class yudingjilu_list : System.Web.UI.Page
{
	//tixxixngdixngyxi
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {	
			...
			//addlixandxongxlz
            string sql;
            sql = "select * from yudingjilu order by id desc";
            getdata(sql);
        }
    }
    ...
    {
        string sql;
        sql = "select * from yudingjilu where 1=1";
     ...
     protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        new Class1().ToExcel(DataGrid1, "yudingjilu");
    }
