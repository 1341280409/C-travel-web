                      ...
                      <tr>
                        ...
                        <td height="233" valign="top" bgcolor="#F6F9F2">
                          ...
                          <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse" class="newsline"> 
								<tr>
								 <td width='11%' height=44>酒店名称：</td><td width='39%'><%=njiudianmingcheng%></td><td  rowspan=6 align=center><a href="<%=ntupian%>" target=_blank><img src=<%=ntupian%> width=228 height=215 border=0></a></td></tr><tr>			<td width='11%' height=44>酒店类型：</td><td width='39%'><%=njiudianleixing%></td></tr><tr>			<td width='11%' height=44>所在城市：</td><td width='39%'><%=nsuozaichengshi%></td></tr><tr>			<td width='11%' height=44>房号：</td><td width='39%'><%=nfanghao%></td></tr><tr>			<td width='11%' height=44>房间类型：</td><td width='39%'><%=nfangjianleixing%></td></tr><tr>						<td width='11%' height=44>价格：</td><td width='39%'><%=njiage%></td></tr><tr>			<td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" style='border:solid 1px #000000; color:#666666' /><input type=button name=Submit52 value=打印 onClick="javascript:window.print()" style='border:solid 1px #000000; color:#666666' />
                                     <asp:Button ID="Button1" runat="server" Text="预订" OnClick="Button1_Click" /></td></tr>
