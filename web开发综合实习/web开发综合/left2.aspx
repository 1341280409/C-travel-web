...
<body style="margin: 0; border: 0;">
        ...
        <div class="main" id="menua">
			...
			<h3 menuid="1"  id="menu1" onclick="showsubmenu(1)" toggleGroup="on" class="menutitle"><div class="bt1"><span>个人资料管理</span></div></h3>
				<ul id="submenu1">
					<li><a href="yonghuzhuce_updt2.aspx" target="frmright">个人资料管理</a></li>
					
				</ul>

            <h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2"><span>预订记录管理</span></div></h3>
				<ul id="submenu2">
					
					<li><a href="yudingjilu_list2.aspx" target="frmright">预订记录查询</a></li>
				</ul>
			
			<%--<h3 menuid="3"  id="menu3" onclick="showsubmenu(3)" toggleGroup="on" class="menutitle"><div class="bt3"><span>站内新闻管理</span></div></h3>
				<ul id="submenu3">
